...
async def build_graph_with_endpoints2(stations, origin=None, destination=None,
    ...
    # 批量导航距离
    nav_matrix = await get_distance_matrix_batched(coords, coords, to_lists, ak) if ak else None
